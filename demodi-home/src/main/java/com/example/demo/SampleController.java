...
import com.example.demo.di.sample.SampleDtoList;
import com.example.demo.di.sample.TodoDTO;
...
public class SampleController {
	...
	// vo 이용해서 값을 받는거
	// SampleDtoList(list=[SampleDto(name=kim, age=10, tel=null),
	// SampleDto(name=park, age=20, tel=null)])
	...
	// SampleDtoList(list=[SampleDto(name=kim, age=10, tel=null),
	// SampleDto(name=yeon, age=20, tel=null)])
	...
	public String ex02(@RequestParam(name = "username") String name,
		...
		// String name = Request.getParam("username"); //이게 이거임
	...
	// [14:43:37] DEBUG com.example.demo.SampleController - [18] SampleDto(name=kim,
	// age=10, tel=null)
	@GetMapping("/ex01")
